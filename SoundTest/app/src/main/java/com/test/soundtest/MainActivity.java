...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final SeekBar audioProgress = (SeekBar) findViewById(R.id.musicProgressBar);
        audioProgress.setMax(mPlayer.getDuration());

        new Timer().scheduleAtFixedRate(new TimerTask() {
            @Override
            public void run() {
                audioProgress.setProgress(mPlayer.getCurrentPosition());
            }
        }, 0, 1000);
