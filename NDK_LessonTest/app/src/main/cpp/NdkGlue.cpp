...
extern "C" {
JNIEXPORT void JNICALL Java_com_test_ndk_1lessontest_GL2JNILib_onCreate(JNIEnv *env, void *reserved,
                                                                    jobject assetManager);
JNIEXPORT void JNICALL Java_com_test_ndk_1lessontest_GL2JNILib_onDestroy(JNIEnv *env, jobject obj);

JNIEXPORT void JNICALL Java_com_test_ndk_1lessontest_GL2JNILib_init(JNIEnv *env, jobject obj,
                                                                jint width, jint height);
JNIEXPORT void JNICALL Java_com_test_ndk_1lessontest_GL2JNILib_step(JNIEnv *env, jobject obj);
};
